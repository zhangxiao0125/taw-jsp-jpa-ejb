 ...
 * @author cecil
 */
@WebServlet(name = "AddProductoFavorito", urlPatterns = {"/AddProductoFavorito"})
public class AddProductoFavorito extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(!prodfav.contains(producto))
        {
            prodfav.add(producto);
       
            usuario.setProductoList(prodfav);
